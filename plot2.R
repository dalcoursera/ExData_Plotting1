# plot2.R generates plot2.png, the line graph for Global Active Power on
...
# Make the line graph PNG
png(filename = "plot2.png")
plot(datetime, twodaydata$GAP, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)", main = "")
dev.off()
